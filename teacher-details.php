...
<html lang="en">
    <head>
        ...
        <title>GLDMS | Guest Details</title>
        <!-- Favicon-->
            ...
            <section class="py-5">
                <div class="container px-5 my-5">
                    <div class="text-center mb-5">
                        <h1 class="fw-bolder text-white"><?php  echo htmlentities($row->Name);?>'s Details</h1>
                    ...
                    <div class="row gx-5">
                     ...
                     <!--        <h2 class="fw-bolder mb-3">Persoanl Details </h2> -->
                            <div class="accordion mb-5" id="accordioExample">
                                <div class="accordion-item">
                                    <h3 class="accordion-header"  id="headingOne"><button class="accordion-button bg-light text-dark" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">Personal Details</button></h3>
   ...
   <tr>
                  ...
                  <tr>
                      ...
                      <td><?php  echo htmlentities($row->RegDate);?></td>
                            ...
                            <div class="accordion mb-5 mb-xl-0" id="accordionExample2">
                                <div class="accordion-item">
                                    <h3 class="accordion-header" id="headingOne"><button class="accordion-button bg-light text-dark" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">Professional Details</button></h3>
                  ...
                  <tr>
                      ...
                      <td><?php  echo htmlentities($row->description);?></td>
                        ...
                        <div class="col-xl-4">
                            <div class="card border-0 bg-warning mt-xl-5">
...
<input type="submit" class="btn btn-primary bg-dark" name="submit">
</form>
