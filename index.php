...
<html lang="en">
    <head>
        ...
        <title>Guest Lecture Details Management System</title>
        <!-- Favicon-->
                    ...
                    <div class="row gx-5 align-items-center justify-content-center">
                        <div class="col-lg-8 col-xl-7 col-xxl-6">
                            <div class="my-5 text-center text-xl-start">
                                <h1 class="display-5 fw-bolder text-white mb-2">Guest Lecture Details Management System</h1>
                                
                                <div class="d-grid gap-3 d-sm-flex justify-content-sm-center justify-content-xl-start" style="margin-top:5%;">
                                    <a class="btn btn-dark btn-lg px-4 me-sm-3" href="teacher/signup.php">Guest Signup/Registration</a>
                                    <a class="btn btn-outline-light btn-lg px-4" href="teacher/index.php">Guest Login</a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row gx-5 justify-content-center">
                        <div class="col-lg-8 col-xl-6">
                            <div class="text-center">
                                <h2 class="fw-bolder">Listed Guest</h2>
<hr color="red" />
                            </div>
                        </div>
                    </div>
