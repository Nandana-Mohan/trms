...
<head>
    ...
    <title>GLDMS || Guest Profile</title>
                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li><a href="manage-teacher.php">Update Guest</a></li>
...
<label for="company" class=" form-control-label">Guest Name</label>
<input type="text" name="tname" value="<?php  echo $row->Name;?>" class="form-control" id="tname" required="true">
</div>

<div class="form-group">
<label for="company" class=" form-control-label">Guest Pic</label> &nbsp;
<?php if($row->Picture==''):?>
...
<div class="form-group">
<label for="street" class=" form-control-label">Guest Email ID</label>
...
<div class="col-12">
<div class="form-group"><label for="city" class=" form-control-label">Guest Mobile Number</label><input type="text" name="mobilenumber" id="mobilenumber" value="<?php  echo $row->MobileNumber;?>" class="form-control" required="true" maxlength="10" pattern="[0-9]+"></div>
</div>
</div>
...
<div class="row form-group">
<div class="col-12">
<div class="form-group"><label for="city" class=" form-control-label">Guest Address</label><textarea type="text" name="address" id="address" class="form-control" rows="3" cols="12" required="true"><?php  echo $row->Address;?></textarea></div>
</div>
</div>
