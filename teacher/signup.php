        ...
        <div class="container">
            <div class="login-content">
                <div class="login-logo">
                    <h3 style="color:black">Guest Lecture Details Management System  </h3>
                    <hr  color="red"/>
                     <h3 style="color:black"> Guest Registration </h3>
                    <hr  color="red"/>
                </div>
                        ...
                        <div class="form-group">
                           ...
                           <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <button type="submit" class="bg-dark btn btn-success btn-flat m-b-30 m-t-30" name="submit">Sign Up</button>
