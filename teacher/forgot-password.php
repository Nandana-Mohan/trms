...
<head>
    ...
    <title>GLDMS Forgot Password</title>
        ...
        <div class="container">
            <div class="login-content">
                <div class="login-logo">
                      <h3 style="color:#fff">Guest Lecture Details Management System </h3>
                    <hr  color="red"/>
                </div>
...
<button type="submit" class="bg-dark btn btn-success btn-flat m-b-30 m-t-30" name="submit">Reset</button>
</form>
